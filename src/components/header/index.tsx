...
export default function Header() {
  ...
  return (
    <Box className="w-screen h-12 fixed top-0 left-0 flex items-center shadow-sm z-10" style={{ background: 'var(--color-background)' }}>
      <Box className="relative w-full h-full flex items-center px-4">
        ...
        <Box className="flex items-center gap-3 py-2 px-2 z-10">
