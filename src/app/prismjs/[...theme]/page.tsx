...
export default async function HighlightDemo({
  ...
  params: { theme: string[], uri: string };
}) {
  ...
  const styleLinkAdditional = `https://cdnjs.cloudflare.com/ajax/libs/prism-themes/1.9.0/${theme === 'prism' ? 'prism' : 'prism-' + theme}.min.css`;
  return (
    <div className="box-border lg:p-6 h-full">
      <link rel="stylesheet" href={styleLink}></link>
      <link rel="stylesheet" href={styleLinkAdditional}></link>
